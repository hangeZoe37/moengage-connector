...
export default function OverviewPage() {
  ...
  useEffect(() => {
    console.log('OverviewPage Mounted or Dependencies Changed');
    load();
    // Removed interval for now to prevent loops
  }, [datePreset]); // Reduced dependencies to prevent any potential loops
        ...
        <div style={{ overflowX: 'auto', padding: '0 24px 24px' }}>
          <table className="data-table">
            ...
            <tbody>
              ...
              {(!metrics || !metrics.clients || metrics.clients.length === 0) && (
                <tr>
