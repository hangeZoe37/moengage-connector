...
| replied | When the user sends replies, such as simple text, postback, media, video, PDF, and location. For more information, refer to the Callback Event Payload. |
...
- [Notification Replied — Text Reply (Simple)](#notification-replied--text-reply-simple)
- [Notification Replied — Text Reply (with Postback)](#notification-replied--text-reply-with-postback)
- [Notification Replied — Media Replies (Image)](#notification-replied--media-replies-image)
- [Notification Replied — Media Replies (Video)](#notification-replied--media-replies-video)
- [Notification Replied — Media Replies (PDF)](#notification-replied--media-replies-pdf)
- [Notification Replied — Media Replies (Location)](#notification-replied--media-replies-location)
...
### Notification Replied — Text Reply (Simple)
...
### Notification Replied — Text Reply (with Postback)
...
### Notification Replied — Media Replies (Image)
...
### Notification Replied — Media Replies (Video)
...
### Notification Replied — Media Replies (PDF)
...
### Notification Replied — Media Replies (Location)
